...
isca_monsoon_hm('half_10_land_tibet')
#isca_monsoon_hm('half_land_longhill_30N')
#isca_monsoon_hm('half_land_longhill_0')
#isca_monsoon_hm('half_land_roundhill_east')
#isca_monsoon_hm('half_land_roundhill_west')
#isca_monsoon_hm('half_land_roundhill_centre')
